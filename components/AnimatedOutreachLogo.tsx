    ...
    <div className={`relative w-full h-full flex items-center justify-center select-none pointer-events-none ${className}`}>
      ...
      >
        ...
        <g opacity="0.65">
          ...
          <text x="440" y="415" fill="#d8b4fe" fontSize="7.5" fontFamily="monospace" letterSpacing="0.5px" textAnchor="middle" opacity="0.8">CROSS-CHANNEL COMPILING: {getPercent(0.3, 0.4)}%</text>
        </g>
